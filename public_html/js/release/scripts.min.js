...
(function(BARDIS, $, window, document, undefined) {
    ...
    BARDIS.mapConfig = {
        ...
        showMap: function() {
            ...
            BARDIS.mapConfig.map_to_html = contentString + '<p>Get Directions: <b>To here</b> - <a href="javascript:BARDIS.mapConfig.mapFromHere(1)">From here</a></p>' + '<form action="http://maps.google.com/maps" method="get"" target="_blank"><label for="saddr">Start address:</label>' + '<input type="text" size="40" maxlength="80" name="saddr" id="saddr" value="" /><br />' + '<input class="button small" value="Get Directions" type="submit" />' + '<input type="hidden" name="daddr" value="' + BARDIS.mapConfig.mapLatitude + "," + BARDIS.mapConfig.mapLongitude + "(" + BARDIS.mapConfig.markerTitle + ")" + '"/></form>';
            BARDIS.mapConfig.map_to_html2 = contentString2 + '<p>Get Directions: <b>To here</b> - <a href="javascript:BARDIS.mapConfig.mapFromHere(2)">From here</a></p>' + '<form action="http://maps.google.com/maps" method="get"" target="_blank"><label for="saddr">Start address:</label>' + '<input type="text" size="40" maxlength="80" name="saddr" id="saddr" value="" /><br />' + '<input class="button small" value="Get Directions" type="submit" />' + '<input type="hidden" name="daddr" value="' + BARDIS.mapConfig.mapLatitude2 + "," + BARDIS.mapConfig.mapLongitude2 + "(" + BARDIS.mapConfig.markerTitle2 + ")" + '"/></form>';
            BARDIS.mapConfig.map_from_html = contentString + '<p>Get Directions: <a href="javascript:BARDIS.mapConfig.mapToHere(1)">To here</a> - <b>From here</b></p>' + '<form action="http://maps.google.com/maps" method="get"" target="_blank"><label for="daddr">End address:</label>' + '<input type="text" size="40" maxlength="80" name="daddr" id="daddr" value="" /><br />' + '<input class="button small" value="Get Directions" type="submit" />' + '<input type="hidden" name="saddr" value="' + BARDIS.mapConfig.mapLatitude + "," + BARDIS.mapConfig.mapLongitude + "(" + BARDIS.mapConfig.markerTitle + ")" + '"/></form>';
            BARDIS.mapConfig.map_from_html2 = contentString2 + '<p>Get Directions: <a href="javascript:BARDIS.mapConfig.mapToHere(2)">To here</a> - <b>From here</b></p>' + '<form action="http://maps.google.com/maps" method="get"" target="_blank"><label for="daddr">End address:</label>' + '<input type="text" size="40" maxlength="80" name="daddr" id="daddr" value="" /><br />' + '<input class="button small" value="Get Directions" type="submit" />' + '<input type="hidden" name="saddr" value="' + BARDIS.mapConfig.mapLatitude2 + "," + BARDIS.mapConfig.mapLongitude2 + "(" + BARDIS.mapConfig.markerTitle2 + ")" + '"/></form>';
    ...
    BARDIS.mailchimp = {
        init: function() {
            window.fnames = [ "EMAIL", "FNAME", "LNAME", "GROUP", "PHONE", "COMMENTS" ];
            window.ftypes = [ "email", "text", "text", "dropdown", "phone", "text" ];
        }
    };
    BARDIS.touch = {
        init: function() {}
...
(function($) {
    ...
    $.validator.addMethod("mc_date", function(date, element, grouping_class) {
        ...
        if ($fields.filter(":filled").length == 0 && this.optional(element)) {
            ...
            if (dateArray["year"].length < 4) {
                dateArray["year"] = parseInt(dateArray["year"]) < 50 ? 2e3 + parseInt(dateArray["year"]) : 1900 + parseInt(dateArray["year"]);
            }
    ...
    $.validator.addMethod("skip_or_complete_group", function(value, element, grouping_class) {
        var $fields = $("input:not(:hidden)", $(element).closest(grouping_class)), $fieldsFirst = $fields.eq(0), validator = $fieldsFirst.data("valid_skip") ? $fieldsFirst.data("valid_skip") : $.extend({}, this), numberFilled = $fields.filter(function() {
            return validator.elementValue(this);
        }).length, isValid = numberFilled === 0 || numberFilled === $fields.length;
...
(function($) {
    ...
    window.mc = {
        ...
        closePopup: function() {
            ...
            var now = new Date();
            var expires_date = new Date(now.getTime() + 31536e6);
